...
class GambitUser {
  ...
  const GambitUser({
    ...
    required this.role, required this.isActive, required this.mustChangePw, required this.createdAt, this.fullName,
    this.companyId,
    this.recoveryEmail,
  });
...
class GambitCompany {
  ...
  const GambitCompany({
    ...
    required this.createdAt, this.warningMessage,
  });
...
class GambitClaims {
  ...
  const GambitClaims({
    required this.sub,
    required this.username,
    required this.role, required this.mustChangePw, required this.iat, required this.exp, this.fullName,
    this.companyId,
  });
...
class GambitDocument {
  ...
  const GambitDocument({
    ...
    required this.createdAt, this.url,
    this.expiryDate,
  });
...
class GambitTrip {
  ...
  const GambitTrip({
    ...
    required this.status, required this.origin, required this.destination, required this.createdAt, this.tripType,
    this.cargoType,
